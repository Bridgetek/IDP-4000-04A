...
int main(int argc, char *argv[])
{
	...
	
	{
		...
		if (stat("SmartHomeControlHub__Flash.bin", &st) == 0)
		{
#ifdef _WIN32
			wcscpy_s(ep.FlashFilePaths[ESD_FLASH_BT815], _countof(ep.FlashFilePaths[ESD_FLASH_BT815]), L"SmartHomeControlHub__Flash.bin");
#endif
		}
#endif

...
#ifndef Usr_Cool_Page__H
#define Usr_Cool_Page__H
...
#define Usr_Cool_Page_CLASSID 0xB726E4B8
ESD_SYMBOL(Usr_Cool_Page_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Usr_Cool_Page, Include = "Usr_Cool_Page.h", Callback, X = 0, Y = 0, Width = 400, Height = 300, Page)
typedef struct
{
	union
	{

...
#ifndef Usr_Heat_Page__H
#define Usr_Heat_Page__H
...
#define Usr_Heat_Page_CLASSID 0x14B3D353
ESD_SYMBOL(Usr_Heat_Page_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Usr_Heat_Page, Include = "Usr_Heat_Page.h", Callback, X = 0, Y = 0, Width = 400, Height = 300, Page)
typedef struct
{
	union
	{
